...
class ProductServiceIntegrationTests extends GroovyTestCase {
	...
	void validateProducts_shouldCreateNewProductWithNewCategory() {
        ...
        // not-null property references a null or transient value: Product.dateCreated; nested exception is org.hibernate.PropertyValueException: not-null property references a null or transient value: Product.dateCreated
